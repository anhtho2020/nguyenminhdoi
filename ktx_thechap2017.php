                        ...
                        echo "<tr>";
                          echo "<th > Tên dãy: </th>";
                              echo "<select name=\"idday\" id=\"idday\" onchange=\"load()\">";
                                  ...
                                  echo $query_day;
                                  $result_day=mysqli_query($query_day, $link);
               ...
               <div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $totalRows = 0;       
                            $stSQL ="select a.ID_DSHSSV,a.MAHSSV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI,b.NGAYNOITRU,c.TENPHONG from dshssv a,danhsachnoitrum b,phong c  where a.ID_DSHSSV =b.ID_SINHVIEN and b.ID_PHONG=c.ID_PHONG and c.ID_PHONG=$idphong and a.ID_DSHSSV not in (select ID_SINHVIEN from thechap2017 where ID_SINHVIEN is not null)";// from danhsachnoitru where ID_SINHVIEN is not null)";// and xoaten=0 and datotnghiep=0 and not in ()";  
                            //echo $stSQL;
