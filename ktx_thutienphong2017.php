...
//        echo $idphong;
        ...
        for($i=0; $i<$sopt-1; $i++)
        {
            ...
            if($kt>=1)
            {
                ...
                $query="insert into thutienphongsinhvien2017(ID_SINHVIEN,SOTHANGNOP,DONGIATHANG,MUCGIAM,THANHTIEN,NGAYTHU,HOCKY,NAMHOC,NGUOITHU,ID_PHONG,GHICHU) "
                               . "values($arr[$i],$sothang,$dongiathang,'$mg',$st,'$ngaythu','$hocky','$namhoc','$nguoithu',$idphong,'$gh')";
                   ...
                   <div class="panel-body">                   		                       
                       ...
                       echo "</tr>";
                        ...
                        $namtruoc=$now["year"]-1;
                            ...
                            echo "<td> Năm học: </td>";
                            echo "<td> <input type=\"text\" name=\"namhoc\" id=\"namhoc\" size=\"10\" maxlength=\"10\" value=\"2017-2018\" </td>";
                        echo "</tr>";
                        echo "</div>";
                        ...
                        echo "<tr>";
                            echo "<td> Đơn giá: </td>";
                            echo "<input type=\"text\" name=\"dongiathang\" id=\"dongiathang\" size=\"10\" maxlength=\"10\" value=\"90000\" </td>";
                        echo "</tr>";
