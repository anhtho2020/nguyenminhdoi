...
echo "</script>";
    ...
    $link=  clsConnet::DBConnect();
        ...
        for($i=0; $i<$sopt-1; $i++){
            ...
            $result_ngnt = mysql_query($query_ngnt, $link);  
            $totalRows_ngnt=mysql_num_rows($result_ngnt);
            while($row_ngnt = mysql_fetch_array ($result_ngnt))
            {
        ...
        for($i=0; $i<$sopt-1; $i++){
            ...
            $resultIns = mysql_query($qInsert, $link);  
            $totalRowsIns=mysql_num_rows($resultIns);// echo $totalRowsIns;
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $stSQL ="select a.ID_SINHVIEN,a.MASV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI,"
                                    ...
                                    . " phong c,lopchuyennganh d,thechap e  where a.ID_SINHVIEN =b.ID_SINHVIEN and "
                                    . " b.ID_PHONG=c.ID_PHONG and a.ID_LOPCHUYENNGANH=d.ID_LOPCHUYENNGANH and "
                                    . " a.ID_SINHVIEN =e.ID_SINHVIEN and c.ID_PHONG=$idphong";// from danhsachnoitru where ID_SINHVIEN is not null)";
                            //echo $stSQL;
