                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            ...
                            $stSQL ="select a.ID_LIENTHONG,a.MASV,a.HODEM,a.TEN,a.NGAYSINH,a.PHAI,"
                                    ...
                                    . "phong c,loplt d, thechaplt e  where a.ID_LIENTHONG =b.ID_LIENTHONG and "
                                    . "b.ID_PHONG=c.ID_PHONG and a.ID_LOP=d.ID_LOPLT and "
                                    . " a.ID_LIENTHONG=e.ID_LIENTHONG and c.ID_PHONG=$idphong";// from danhsachnoitru where ID_SINHVIEN is not null)";// and xoaten=0 and datotnghiep=0 and not in ()";  
                            //echo $stSQL;
