	...
	{ $kthk="3";}
        ...
        for($i=0; $i<$sopt-1; $i++)
        {
            ...
            if($kt>=1)
            {
                ...
                $query="insert into thutienphongsinhvien(ID_SINHVIEN,DONGIA,NGAYTHU,HOCKY,NAMHOC,NGUOITHU,GHICHU,SOTHANGNOP,DONGIATHANG,MUCGIAM,ID_PHONG) "
                               . "values($arr[$i],$st,'$ngaythu','$hocky','$namhoc','$nguoithu','$gh',$sothang,$dongiathang,'$mg',$idphong)";
