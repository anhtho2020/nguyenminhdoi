				...
				<div class="panel">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php  
                            ...
                            {
                                $stSQL_slsinhvien ="select count(ID_SINHVIEN) as total from danhsachnoitru where ID_PHONG='".$row_phong["ID_PHONG"]."'";  
                                $result_slsinhvien = mysqli_query($link,$stSQL_slsinhvien);
                                $row_slsinhvien = mysqli_fetch_array ($result_slsinhvien);
                                
                                $stSQL_slsinhvien2017 ="select count(ID_SINHVIEN) as total from danhsachnoitrum where ID_PHONG='".$row_phong["ID_PHONG"]."'";  
                                $result_slsinhvien2017 = mysqli_query($link,$stSQL_slsinhvien2017);
                                $row_slsinhvien2017 = mysqli_fetch_array ($result_slsinhvien2017);
                                
                                $stSQL_slsinhvienlt ="select count(ID_LIENTHONG) as total from dssvltnoitru where ID_PHONG='".$row_phong["ID_PHONG"]."'";  
